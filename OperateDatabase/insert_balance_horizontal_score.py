...
# @File     :insert_balance_horizontal
...
def select_profitability_ability_list(company_id, company_year):
    ...
    for i in range(0, 3):
        cursor.execute("select %s from balance_horizontal where company_id=%d and company_year=%d" %
...
def calculate_score(company_id, company_year):
    ...
    for i in range(0, len(select_inventory_turnover_days_list(company_id, company_year))):
        ...
        if inventory_turnover_days <= -100:
            score = 5
        elif inventory_turnover_days <= -30:
            score = 4
        elif inventory_turnover_days <= 30:
            score = 3
        elif inventory_turnover_days <= 100:
            score = 2
        else:
            score = 1
        score_list.append(score)
...
def insert_balance_horizontal_score(company_id, company_year):
    insert_sql = "INSERT INTO score_horizontal VALUES (NULL,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%s,%d);" % \
...
insert_balance_horizontal_score(1, 2018)
