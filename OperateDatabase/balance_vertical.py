...
print(alist)
interest_payment_multiple_list = [alist[9] - alist[8], alist[8] - alist[7], alist[7] - alist[6], alist[6] - alist[5],
                                  alist[5] - alist[4],
                                  alist[4] - alist[3], alist[3] - alist[2], alist[2] - alist[1], alist[1] - alist[0]]
...
print(alist)
seaapor_list = [alist[9] - alist[8], alist[8] - alist[7], alist[7] - alist[6], alist[6] - alist[5], alist[5] - alist[4],
                alist[4] - alist[3], alist[3] - alist[2], alist[2] - alist[1], alist[1] - alist[0]]
print(seaapor_list)
print('==============================')
print('meaapor:')
...
print(alist)
meaapor_list = [alist[9] - alist[8], alist[8] - alist[7], alist[7] - alist[6], alist[6] - alist[5], alist[5] - alist[4],
                alist[4] - alist[3], alist[3] - alist[2], alist[2] - alist[1], alist[1] - alist[0]]
print(meaapor_list)
print('==============================')
...
print(alist)
ebitda_list = [alist[9] - alist[8], alist[8] - alist[7], alist[7] - alist[6], alist[6] - alist[5], alist[5] - alist[4],
               alist[4] - alist[3], alist[3] - alist[2], alist[2] - alist[1], alist[1] - alist[0]]
print(ebitda_list)
print('==============================')
